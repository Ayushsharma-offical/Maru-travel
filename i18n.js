...
const TRANSLATIONS = {
  en: {
    ...
    'nav.contact': 'CONTACT',
    'nav.login': 'Login',
    'nav.events': 'WEDDINGS & EVENTS',
    'nav.dest_weddings': 'DESTINATION WEDDINGS',
    'nav.corp_events': 'CORPORATE EVENTS',
    'dest.india': 'INDIA',
    'dest.nepal': 'NEPAL',
    'dest.bhutan': 'BHUTAN',
    ...
    'about.founder.p1': 'At Maru Travel, we believe every journey is an opportunity to create lifelong memories. Built on more than two decades of collective professional experience in the global travel industry, our company was founded to provide seamless, high-quality, and personalized travel solutions worldwide.',
    'about.founder.p2': 'Driven by deep destination expertise, strong global networks, and a passion for exceptional service, our team has established trusted partnerships with top international travel organizations. We specialize in crafting tailor-made itineraries—from custom leisure holidays, family vacations, and honeymoons to corporate travel, educational groups, and specialized tours across Asia, North America, and South America.',
    ...
    'itin.chat': 'Chat on WhatsApp',
    'about.established': 'Established 2023',
...
'dw.eyebrow': 'MARU TRAVEL INDIA PRESENTS',
    'dw.hero.cal': 'Destination',
    'dw.hero.main': 'WEDDINGS',
    'dw.hero.sub': 'Where every celebration becomes a breathtaking story worth remembering.',
    'dw.fl1': '"Where forever begins..."',
    'dw.fl2': '"Curated with absolute perfection."',
    'dw.fl3': '"A timeless celebration of love."',
    'dw.quote.full': 'Some love stories demand a grand stage. Whether it is the timeless romance of a lakeside palace or the vibrant heritage of a desert fort, we bring your definitive vision to life.',
    'dw.exp.author': '— The Maru Experience',
    'dw.jaipur.num': '01 — RAJASTHAN',
    'dw.jaipur.tag': 'The Pink City — A Royal Celebration',
    'dw.jaipur.desc.full': "Accessibility, heritage and convenience make Jaipur India's most compelling wedding destination. Pink palaces, Aravalli backdrops and world-class luxury hotels create stunning settings.",
    'dw.jaipur.li1': 'Bespoke Heritage Venue Scouting & Selection',
    'dw.jaipur.li2': 'Grand Royal Decor & Floral Styling',
    'dw.jaipur.li3': 'Seamless VIP Guest Hospitality & Transfers',
    'dw.jaipur.li4': 'Curated Rajasthani & Global Culinary Experiences',
    'dw.jodhpur.num': '02 — RAJASTHAN',
    'dw.jodhpur.tag': 'Where Royalty Lives On',
    'dw.jodhpur.desc': "Experience Rajasthan's richest royal legacy. Historic palaces and grand havelis where modern luxury blends seamlessly with centuries of tradition for a truly majestic celebration.",
    'dw.jodhpur.li1': 'Historic Palace & Fort Venue Curation',
    'dw.jodhpur.li2': 'End-to-End Regal Event Production',
    'dw.jodhpur.li3': 'Luxury Fleet & Airport Logistics Management',
    'dw.jodhpur.li4': 'Authentic Marwari Royal Feast Design',
    'dw.kumbhalgarh.num': '03 — RAJASTHAN',
    'dw.kumbhalgarh.tag': 'A Fairytale Within the Aravallis',
    'dw.kumbhalgarh.desc': 'Steeped in royal legacy, this is an extraordinary setting for unforgettable celebrations. Magnificent fort architecture, traditional cuisine and dramatic landscapes.',
    'dw.kumbhalgarh.li1': 'Fortress & Mountain Retreat Selection',
    'dw.kumbhalgarh.li2': 'Intimate Fairytale Themed Ambience & Decor',
    'dw.kumbhalgarh.li3': 'Comprehensive Guest Travel & Accommodation',
    'dw.kumbhalgarh.li4': 'Artisanal Highland Dining & Folk Celebrations',
    'dw.udaipur.num': '04 — RAJASTHAN',
    'dw.udaipur.tag': 'Romance in Every Frame',
    'dw.udaipur.desc': "Shimmering lakes, magnificent palaces and the Aravallis create the world's most naturally romantic wedding backdrop. The iconic waterfront settings are simply unmatched.",
    'dw.udaipur.li1': 'Iconic Waterfront Palace & Island Scouting',
    'dw.udaipur.li2': 'Cinematic Lakefront Production & Lightscapes',
    'dw.udaipur.li3': 'Private Boat Transfers & Luxe Concierge',
    'dw.udaipur.li4': 'Bespoke Sunset Dining & Curated Menus',
    'dw.delhi.num': '05 — DELHI NCR',
    'dw.delhi.tag': 'Heritage Meets Contemporary Luxury',
    'dw.delhi.desc': "India's capital delivers exceptional connectivity and world-class event infrastructure. Vintage havelis and heritage hotels create unforgettable, grand weddings.",
    'dw.delhi.li1': 'Elite Heritage Estate & Ballroom Curation',
    'dw.delhi.li2': 'Avant-Garde Stage Design & Production',
    'dw.delhi.li3': 'Seamless Multi-City Logistics & Protocol',
    'dw.delhi.li4': 'Global Gourmet Fusion & Royal Feasts',
    'dw.exp.cal': 'The Maru Experience',
    'dw.exp.title': 'Our Expertise',
    'dw.exp.sub': 'Beautifully Planned. Exquisitely Executed.',
    'dw.srv.1.name': 'Venue Selection',
    'dw.srv.1.desc': 'Find the perfect palace, resort, heritage property or luxury hotel for your celebration.',
    'dw.srv.2.name': 'Guest Management',
    'dw.srv.2.desc': 'Accommodation, airport transfers and seamless logistics across your entire event.',
    'dw.srv.3.name': 'Ceremonies',
    'dw.srv.3.desc': 'Curate traditional ceremonies, cultural experiences and truly memorable celebrations.',
    'dw.srv.4.name': 'Décor & Styling',
    'dw.srv.4.desc': 'A wedding atmosphere entirely authentic to your personality, vision and culture.',
    'dw.srv.5.name': 'Food & Hospitality',
    'dw.srv.5.desc': 'Curate exceptional menus, tastings and world-class hospitality for all your guests.',
    'dw.srv.6.name': 'Travel & Logistics',
    'dw.srv.6.desc': 'Complete management of transportation, arrivals, departures and destination logistics.',
    'tc.eyebrow': '✦ THE MARU EXPERIENCE ✦',
    'tc.title': 'Happy Customers',
    'tc.sub': 'Stories from the hearts of those who travelled with us',
    'tc.scroll': 'Hover to reveal colors • Scroll down',
    'tc.verified': '✓ Verified Guest',
    'tc.t0.tag': '✦ Royal Rajasthan Expedition',
    'tc.t0.quote': 'Every moment was pure magic. The heritage palaces of Rajasthan took our breath away — Maru Travel made every detail feel completely effortless and truly luxurious. Absolutely unforgettable.',
    'tc.t0.name': 'Ji-woo Kim',
    'tc.t0.loc': '🇰🇷 Seoul, South Korea',
    'tc.t1.tag': '✦ Golden Triangle & Udaipur',
    'tc.t1.quote': 'Our honeymoon in Udaipur was straight out of a fairy tale. Private sunset boat ride on Lake Pichola, lakeside palace dinner — we felt like royalty the entire week. Thank you Maru Travel!',
    'tc.t1.name': 'Min-ho Choi',
    'tc.t1.loc': '🇰🇷 Busan, South Korea',
    'tc.t2.tag': '✦ Family Heritage Vacation',
    'tc.t2.quote': 'Traveling with elderly parents is never simple — but the team ensured absolute comfort at every step. The pace was gentle, the vehicles spotless, and every hotel was breathtaking.',
    'tc.t2.name': 'Seo-yeon Park',
    'tc.t2.loc': '🇰🇷 Incheon, South Korea',
    'tc.t3.tag': '✦ Varanasi & Agra Photography',
    'tc.t3.quote': 'As a photographer, the itinerary was masterfully timed. Golden hour at the Taj Mahal, dawn at Varanasi ghats — our guide knew exactly where to take us for each frame.',
    'tc.t3.name': 'Hyun-woo Lee',
    'tc.t3.loc': '🇰🇷 Daegu, South Korea',
    'tc.t4.tag': '✦ Maharaja Luxury Rail Journey',
    'tc.t4.quote': 'The luxury train journey was spectacular. Watching the Thar desert roll by from a royal cabin over authentic Rajasthani cuisine — nothing in the world compares to this hospitality.',
    'tc.t4.name': 'Soo-jin Kang',
    'tc.t4.loc': '🇰🇷 Gwangju, South Korea',
    'tc.t5.tag': '✦ Customized Luxury Tour',
    'tc.t5.quote': 'From airport VIP pick-up to final drop-off, the warmth and professionalism were flawless. Maru Travel truly understands what high-end bespoke travel means.',
    'tc.t5.name': 'Dong-hyun Yoon',
    'tc.t5.loc': '🇰🇷 Daejeon, South Korea',
    'tc.t6.tag': '✦ Taj Palaces & Wildlife Safari',
    'tc.t6.quote': 'The Taj palaces were a dream, but what made it unforgettable was our trip coordinator checking in on us every single day. I will absolutely come back and book again!',
    'tc.t6.name': 'Eun-ji Jung',
    'tc.t6.loc': '🇰🇷 Ulsan, South Korea',
  ...
  ko: {
    ...
    'nav.login': '로그인',
    'nav.events': '웨딩 & 이벤트',
    'nav.dest_weddings': '데스티네이션 웨딩',
    'nav.corp_events': '기업 행사',
    'dest.india': '인도',
    'dest.nepal': '네팔',
    'dest.bhutan': '부탄',
    'dest.srilanka': '스리랑카',
    ...
    'about.established': '2023년 설립',
    'about.founder.title': '평생의 추억 만들기',
    'about.founder.p1': '마루 트래블에서는 모든 여행이 평생의 추억을 만들 수 있는 기회라고 믿습니다. 글로벌 여행 산업에서 20년 이상 축적된 전문적인 경험을 바탕으로, 전 세계적으로 원활하고 고품질이며 개인화된 여행 솔루션을 제공하기 위해 설립되었습니다.',
    'about.founder.p2': '깊이 있는 여행지 전문 지식, 강력한 글로벌 네트워크, 그리고 탁월한 서비스에 대한 열정을 바탕으로, 저희 팀은 최고의 국제 여행 기관들과 신뢰할 수 있는 파트너십을 맺었습니다. 저희는 맞춤형 레저 휴가, 가족 여행, 신혼여행부터 아시아, 북미, 남미 전역의 기업 여행, 교육 그룹, 전문 투어에 이르기까지 맞춤형 일정을 제작하는 데 전문화되어 있습니다.',
...
'dw.eyebrow': '마루 트래블 인디아 제공',
    'dw.hero.cal': '데스티네이션',
    'dw.hero.main': '웨딩',
    'dw.hero.sub': '모든 축하의 순간을 영원히 기억될 아름다운 이야기로 만듭니다.',
    'dw.fl1': '"영원이 시작되는 곳..."',
    'dw.fl2': '"완벽함으로 큐레이션되었습니다."',
    'dw.fl3': '"사랑의 시간을 초월한 축하."',
    'dw.quote.full': '어떤 사랑 이야기는 웅장한 무대를 필요로 합니다. 호수 궁전의 영원한 로맨스이든, 사막 요새의 활기찬 유산이든 — 저희가 당신의 확고한 비전을 현실로 만들어 드립니다.',
    'dw.exp.author': '— 더 마루 익스피리언스',
    'dw.jaipur.num': '01 — 라자스탄',
    'dw.jaipur.tag': '핑크시티 – 로열 셀레브레이션',
    'dw.jaipur.desc.full': '접근성, 문화유산과 편의성으로 자이푸르는 인도에서 가장 매력적인 웨딩 목적지입니다. 핑크 궁전들, 아라발리 배경, 세계적 수준의 럭셔리 호텔이 멋진 배경을 만들어냅니다.',
    'dw.jaipur.li1': '맞춤형 헤리티지 장소 탐색 및 선정',
    'dw.jaipur.li2': '그랜드 로열 데코르 및 플로럴 스타일링',
    'dw.jaipur.li3': '원활한 VIP 게스트 호스피탈리티 및 교통',
    'dw.jaipur.li4': '라자스탄 및 글로벌 미식 경험',
    'dw.jodhpur.num': '02 — 라자스탄',
    'dw.jodhpur.tag': '왕족의 유산이 살아있는 곳',
    'dw.jodhpur.desc': '라자스탄의 가장 풍부한 왕족 유산을 경험하세요. 역사적인 궁전과 웅장한 하벨리에서 현대적인 럭셔리가 수세기의 전통과 조화를 이루어 진정 장엄한 축하 행사를 만들어냅니다.',
    'dw.jodhpur.li1': '역사적 궁전 및 요새 장소 큐레이션',
    'dw.jodhpur.li2': '엔드투엔드 왕실 이벤트 프로덕션',
    'dw.jodhpur.li3': '럭셔리 플릿 및 공항 물류 관리',
    'dw.jodhpur.li4': '정통 마르와리 왕실 연회 디자인',
    'dw.kumbhalgarh.num': '03 — 라자스탄',
    'dw.kumbhalgarh.tag': '아라발리의 동화',
    'dw.kumbhalgarh.desc': '왕실 유산에 깊이 빠져든 이 특별한 장소는 잊을 수 없는 축하 행사를 위한 최적의 배경입니다. 웅장한 요새 건축, 전통 요리와 극적인 풍경이 펼쳐집니다.',
    'dw.kumbhalgarh.li1': '성채 및 산악 리트리트 선정',
    'dw.kumbhalgarh.li2': '소규모 동화 테마 분위기 및 데코르',
    'dw.kumbhalgarh.li3': '종합 게스트 여행 및 숙박',
    'dw.kumbhalgarh.li4': '수공예 고원 다이닝 및 민속 축제',
    'dw.udaipur.num': '04 — 라자스탄',
    'dw.udaipur.tag': '모든 프레임 속의 로맨스',
    'dw.udaipur.desc': '반짝이는 호수, 웅장한 궁전, 아라발리가 세계에서 가장 자연스럽게 로맨틱한 웨딩 배경을 만들어냅니다. 상징적인 수변 설정은 타의 추종을 불허합니다.',
    'dw.udaipur.li1': '상징적 워터프론트 궁전 및 섬 탐색',
    'dw.udaipur.li2': '영화적 레이크프론트 프로덕션 및 라이트스케이프',
    'dw.udaipur.li3': '프라이빗 보트 이동 및 럭스 컨시어지',
    'dw.udaipur.li4': '맞춤형 선셋 다이닝 및 큐레이션 메뉴',
    'dw.delhi.num': '05 — 델리 NCR',
    'dw.delhi.tag': '헤리티지와 현대 럭셔리의 만남',
    'dw.delhi.desc': '인도의 수도는 탁월한 연결성과 세계적 수준의 이벤트 인프라를 제공합니다. 빈티지 하벨리와 헤리티지 호텔이 잊을 수 없는 웅장한 웨딩을 만들어냅니다.',
    'dw.delhi.li1': '엘리트 헤리티지 에스테이트 및 볼룸 큐레이션',
    'dw.delhi.li2': '아방가르드 스테이지 디자인 및 프로덕션',
    'dw.delhi.li3': '원활한 멀티시티 물류 및 프로토콜',
    'dw.delhi.li4': '글로벌 고메 퓨전 및 로열 피스트',
    'dw.exp.cal': '더 마루 익스피리언스',
    'dw.exp.title': '아워 엑스퍼티즈',
    'dw.exp.sub': '아름답게 계획되고, 완벽하게 실행됩니다.',
    'dw.srv.1.name': '장소 선정',
    'dw.srv.1.desc': '축하 행사를 위한 완벽한 궁전, 리조트, 헤리티지 부지 또는 럭셔리 호텔을 찾아드립니다.',
    'dw.srv.2.name': '게스트 관리',
    'dw.srv.2.desc': '이벤트 전반에 걸친 숙박, 공항 교통 및 원활한 물류를 제공합니다.',
    'dw.srv.3.name': '의식 행사',
    'dw.srv.3.desc': '전통 의식, 문화 체험 및 진정 기억에 남는 축하 행사를 큐레이션합니다.',
    'dw.srv.4.name': '데코르 & 스타일링',
    'dw.srv.4.desc': '당신의 개성, 비전, 문화에 완전히 충실한 웨딩 분위기를 연출합니다.',
    'dw.srv.5.name': '음식 & 호스피탈리티',
    'dw.srv.5.desc': '모든 게스트를 위한 탁월한 메뉴, 시식 및 세계적 수준의 호스피탈리티를 큐레이션합니다.',
    'dw.srv.6.name': '여행 & 물류',
    'dw.srv.6.desc': '교통, 도착, 출발 및 목적지 물류의 완벽한 관리를 제공합니다.',
    'tc.eyebrow': '✦ 더 마루 익스피리언스 ✦',
    'tc.title': '행복한 고객들',
    'tc.sub': '마루 트래블과 함께 여행한 분들의 진심 어린 이야기',
    'tc.scroll': '마우스를 올려 색상 확인 • 아래로 스크롤',
    'tc.verified': '✓ 인증된 게스트',
    'tc.t0.tag': '✦ 로열 라자스탄 여행',
    'tc.t0.quote': '모든 순간이 순수한 마법이었습니다. 라자스탄의 헤리티지 궁전들은 저희를 숨막히게 했습니다 — 마루 트래블은 모든 디테일을 완전히 손쉽고 진정 럭셔리하게 만들어 주었습니다. 정말 잊을 수 없는 여행이었습니다.',
    'tc.t0.name': 'Ji-woo Kim',
    'tc.t0.loc': '🇰🇷 서울, 대한민국',
    'tc.t1.tag': '✦ 골든 트라이앵글 & 우다이푸르',
    'tc.t1.quote': '우다이푸르에서의 허니문은 동화 속 이야기 같았습니다. 피촐라 호수에서의 프라이빗 선셋 보트 투어, 호수변 궁전 저녁 식사 — 일주일 내내 왕족이 된 느낌이었습니다. 마루 트래블 정말 감사합니다!',
    'tc.t1.name': 'Min-ho Choi',
    'tc.t1.loc': '🇰🇷 부산, 대한민국',
    'tc.t2.tag': '✦ 가족 헤리티지 여행',
    'tc.t2.quote': '연로한 부모님과의 여행은 결코 쉽지 않지만 — 팀이 매 순간 절대적인 편안함을 보장해 주었습니다. 여행 속도는 여유로웠고, 차량은 깔끔했으며, 모든 호텔이 숨막히게 아름다웠습니다.',
    'tc.t2.name': 'Seo-yeon Park',
    'tc.t2.loc': '🇰🇷 인천, 대한민국',
    'tc.t3.tag': '✦ 바라나시 & 아그라 포토그래피',
    'tc.t3.quote': '사진작가로서 일정이 완벽하게 짜여 있었습니다. 타지마할에서의 골든아워, 바라나시 가트에서의 새벽 — 가이드는 매 프레임을 위해 정확히 어디로 데려갈지 알고 있었습니다.',
    'tc.t3.name': 'Hyun-woo Lee',
    'tc.t3.loc': '🇰🇷 대구, 대한민국',
    'tc.t4.tag': '✦ 마하라자 럭셔리 레일 여행',
    'tc.t4.quote': '럭셔리 기차 여행은 장관이었습니다. 로열 캐빈에서 정통 라자스탄 요리를 즐기며 타르 사막을 지나는 풍경 — 세상 어디에도 이런 호스피탈리티는 없습니다.',
    'tc.t4.name': 'Soo-jin Kang',
    'tc.t4.loc': '🇰🇷 광주, 대한민국',
    'tc.t5.tag': '✦ 맞춤형 럭셔리 투어',
    'tc.t5.quote': '공항 VIP 픽업부터 최종 하차까지, 따뜻함과 프로페셔널리즘이 완벽했습니다. 마루 트래블은 진정한 고급 맞춤 여행이 무엇인지 정확히 알고 있습니다.',
    'tc.t5.name': 'Dong-hyun Yoon',
    'tc.t5.loc': '🇰🇷 대전, 대한민국',
    'tc.t6.tag': '✦ 타지 팰리스 & 와일드라이프 사파리',
    'tc.t6.quote': '타지 궁전들은 꿈같았지만, 정말 잊을 수 없게 만든 것은 여행 코디네이터가 매일 우리를 확인해 주었다는 것입니다. 반드시 다시 돌아와 예약할 것입니다!',
    'tc.t6.name': 'Eun-ji Jung',
    'tc.t6.loc': '🇰🇷 울산, 대한민국',
